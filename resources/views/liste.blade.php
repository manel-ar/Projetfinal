                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-header text-center bg-white">
                                <h4 class="card-title">Liste Bons de Commande</h4>
                            </div>
                            <div class="row">
                                <div class="col-12">
                                        ...
                                        <tbody>
                                            ...
                                            <tr id="row{{ $bonDeCommande->id }}">
                                                ...
                                                <td>
                                                    ...
                                                    <span class="badge badge-success">{{ $bonDeCommande->etat }}</span>
                                                    @else
                                                    <span class="badge badge-danger">{{ $bonDeCommande->etat }}</span>
                                                    @endif
                                                </td>

                                                <td>
                                                    <a href="{{ route('getbon', ['id' => $bonDeCommande->id]) }}" class="btn btn-primary btn-sm" title="Voir le Bon de Commande">View</a>
