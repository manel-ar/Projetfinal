                    ...
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-header text-center bg-white">
                                <h4 class="card-title">Liste des Bons de Livraison</h4>
                            </div>
                            <div class="card-body">
                                @if ($bonsDeLivraison->isEmpty())
                                <p class="text-center">Aucun bon de livraison trouvé.</p>
                                @else
                                <table class="table">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('show', ['id' => $bonLivraison->id]) }}" class="btn btn-primary">Détails</a>
                                            </td>
                                        </tr>
                                        @endforeach
